...
<!-- practice using sheets, how to type formula =, how to pull down the formula -->
<!-- or not sheets...practice with colab. downloading. submitting back to github -->
...
- Week Two: January 21, 23: Display Types and Anatomy of a Chart
  ...
  <!-- precoded plots exemplifying graph types. students identify all things -->
  <!-- come up with story for the figures -->
